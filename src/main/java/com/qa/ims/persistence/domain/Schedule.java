...
public class Schedule {
	...
	public Schedule(Long fkDriverID, Long fkLorryID, String area, Date date) {
		super();
	...
	public String toString() {
		return "Schedule ID: " + scheduleId + " Driver ID: " + fkDriverID + ", Lorry ID: " + fkLorryID + " area: "
				+ area + " date created: " + date;
	}
